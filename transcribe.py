...
from ibm_waston import TextToSpeechV1
from ibm_cloud_sdk_core.authenticators import IAMAuthenticator


authenticator = IAMAuthenticator('DxhBruVFc2S2meZRblKb7o9l7B0wNmQSkzn6pJmXwQPb') 
tts = TextToSpeechV1(authenticator=authenticator)
tts.set_service_url('https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/c258fca8-394d-4eea-9c6b-80e86be68e91') 
